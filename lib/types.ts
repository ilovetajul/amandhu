...
export interface QualityInfo {
  QI_ID: number; QI_Name: string; Role: string;
...
export interface AOStyleMaster {
  ...
  "DHU_Target%"?: number; "Finishing_DHU_Target%"?: number;
...
export interface HourlyQualityRow {
  ...
  Line_No: string; Buyer: string; AO_Number: string;
  Style_No: string; Color: string;
  QI_ID: number; QI_Name: string;
...
export interface DefectLog {
  Log_ID: string; HQ_Row_ID: string; Date: string; Line_No: string;
  Hour_Slot: string; Defect_Name: string;
  Defect_Qty: number; Defect_Category: string;
}
export interface FinishingRow {
  Date: string; Line_No: string; AO_Number: string; Style_No: string;
  Buyer: string; Color: string; Unit_No: number;
  Inspected_Qty: number; Defectives_gmts: number;
  "DHU%"?: number; "Target_DHU%"?: number; "Vs_Target%"?: number;
  Remarks?: string;
}
